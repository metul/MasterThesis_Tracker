...
// are shown.
    ...
    struct objects {
        struct object object0;
        struct object object1;
    };

    struct objectPositions {
        struct objects objects123;
        std::mutex m;
    };
    ...
    public:
        //Constructor for object position variables
        Tracker(std::shared_ptr<objectPositions> sharedPtr, std::shared_ptr<marker> sharedPtr2) {
            object_positions_ = sharedPtr;
            marker_ = sharedPtr2;
        }
...
// Constructor and setter methods
        ...
        // Main method
        void StartTracker(bool start_tracking, std::shared_ptr<std::atomic<bool>> stop_tracking_);
    ...
    private:
        //var for object positions
        std::shared_ptr<objectPositions> object_positions_;
